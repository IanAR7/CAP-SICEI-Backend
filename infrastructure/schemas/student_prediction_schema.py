...
class StudentSocioEconomicDataDTO(BaseModel):
    ...
    class Config:
        json_schema_extra = {"example": {"internet_home": True, "has_laptop": True, "is_female": False, "age": 20, "worked_last_week": False, "household_size": 4, "prev_school_public": True, "finished_prev_level": True, "repeated_subjects": False, "work_hours": 0.0}}
