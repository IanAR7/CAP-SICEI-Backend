...
def map_create_subject_dto_to_entity(subject_dto: CreateSubjectDTO) -> Subject:
    ...
    """
    return Subject(id=None, name=subject_dto.name, description=subject_dto.description, credits=subject_dto.credits, semester=subject_dto.semester, professor_id=subject_dto.professor_id)
...
def map_subject_entity_to_model(subject: Subject) -> SubjectModel:
    ...
    """
    return SubjectModel(id=subject.id, name=subject.name, description=subject.description, credits=subject.credits, semester=subject.semester, professor_id=subject.professor_id)
...
def map_update_subject_dto_to_entity(subject_id: str, subject_dto: UpdateSubjectDTO) -> Subject:
    ...
    Returns:
        Subject: The mapped Subject entity.
    """
    return Subject(id=subject_id, name=subject_dto.name, description=subject_dto.description, credits=subject_dto.credits, semester=subject_dto.semester, professor_id=subject_dto.professor_id)
