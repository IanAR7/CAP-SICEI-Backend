...
from infrastructure.mappers.student_mappers import (
    map_student_entity_to_model,
    map_student_model_to_entity,
)
from infrastructure.utils.sort_fields import (
    ALLOWED_SORT_ORDERS,
    ALLOWED_STUDENT_SORT_FIELDS,
)
...
class StudentRepositoryImpl(StudentRepository):
    ...
    def get_average_by_student_id(self, student_id: str) -> float | None:
        ...
        return self.db.query(StudentModel.average).filter(StudentModel.id == student_id).scalar()
