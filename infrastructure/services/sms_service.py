...
class SMSServiceImpl(NotificationService):
    ...
    def _validate_phone_number(self, phone: str) -> bool:
        ...
        if not re.match(pattern, phone):
            ...
            logger.error(f"   Formato esperado: +52XXXXXXXXXX (para México)")
            return False
    ...
    async def send_sms(self, recipients: List[str], message: str) -> bool:
        ...
        try:
            ...
            if len(message) > 160:
                message = message[:157] + "..."
                logger.warning(f"⚠️  Mensaje truncado a 160 caracteres")
            ...
            for phone_number in recipients:
                ...
                try:
                    ...
                    if e.code == 21211:
                        ...
                        logger.error(f"   💡 Permisos insuficientes - número posiblemente no verificado en cuenta Trial")
                    elif e.code == 21614:
