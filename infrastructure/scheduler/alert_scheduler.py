...
class AlertScheduler:
    ...
    def start(self):
        ...
        self.scheduler.add_job(self.check_and_send_scheduled_alerts, trigger=IntervalTrigger(minutes=self.settings.SCHEDULER_INTERVAL_MINUTES), id="check_scheduled_alerts", name="Revisar alertas programadas", replace_existing=True)
