...
class UpdateStudentUseCase:
    def __init__(self, student_repository: StudentRepository, subject_repository: SubjectRepository, grade_repository: GradeRepository):
    ...
    def execute(self, student_data: Student) -> Student:
        ...
        if new_semester is not None and new_semester != current_student.semester:
            ...
            for subject in new_subjects:
                new_grade = Grade(id=None, student_id=current_student.id, subject_id=subject.id, value=0.0)
