...
class UpdateSubjectUseCase:
    def __init__(self, subject_repository: SubjectRepository, grade_repository: GradeRepository, student_repository: StudentRepository):
    ...
    def execute(self, subject_data: Subject) -> Subject:
        ...
        if new_semester is not None and new_semester != current_subject.semester:
            ...
            for student in students_in_new_semester:
                new_grade = Grade(id=None, student_id=student.id, subject_id=current_subject.id, value=0.0)
